...
const vgQuestions = [
  new Question ('Doctor Ivo “Eggman” Robotnik is the enemy of which video game character?', ['Sonic the Hedgehog','Mario', 'Pac-Man', 'Kirby'], ['CSS/gamePhotos/Sonic.jpeg', 'CSS/gamePhotos/Mario.jpeg', 'CSS/gamePhotos/Pac-Man.jpeg', 'CSS/gamePhotos/Kirby.jpeg'], 'Sonic the Hedgehog'),
  new Question ('The Vault Dweller is the protagonist of which video game?', ['Elder Scrolls','Final Fantasy', 'Fallout', 'Persona'], ['CSS/gamePhotos/Elder-Scrolls.jpeg', 'CSS/gamePhotos/Final-Fantasy.jpeg', 'CSS/gamePhotos/Fallout.jpeg', 'CSS/gamePhotos/Persona.jpeg'], 'Fallout'),
  new Question ('Retsu and Geki are computer-controlled opponents in which video game?', ['Tekken','Street Fighter', 'Dead or Alive', 'King of Fighter'], ['CSS/gamePhotos/Tekken.jpeg', 'CSS/gamePhotos/Street-Fighter.jpeg', 'CSS/gamePhotos/DoA.jpeg', 'CSS/gamePhotos/KoF.jpeg'], 'Street Fighter'),
  new Question ('Mario first appeared in which classic video game?', ['Super Mario Bros.','Kirby\'s Dreamland', 'Legend of Zelda: Link\'s Awakening', 'Donkey Kong'], ['CSS/gamePhotos/Super-Mario-Bros.png', 'CSS/gamePhotos/Kirby\'s-dreamland.jpeg', 'CSS/gamePhotos/Links_Awakening.jpeg', 'CSS/gamePhotos/DonkeyKong-Game.jpeg'], 'Donkey Kong'),
  new Question ('The Umbrella Corporation is a pharmaceutical company in which horror video game franchise?', ['Resident Evil','Silent Hill', 'Outlast', 'Left 4 Dead'], ['CSS/gamePhotos/Resident-Evil.jpeg', 'CSS/gamePhotos/Silent-Hill.jpeg', 'CSS/gamePhotos/Outlast.jpeg', 'CSS/gamePhotos/Left4Dead.jpeg'], 'Resident Evil'),
  new Question ('Cloud Strife is the mercenary main character of which video game?', ['Tales of Abyss','Final Fantasy VII', 'Final Fantasy VIII', 'Tales of Symphonia'], ['CSS/gamePhotos/Tales-of-Abyss.jpeg', 'CSS/gamePhotos/Final-Fantasy.jpeg', 'CSS/gamePhotos/Final-Fantasy-8.jpeg', 'CSS/gamePhotos/Tales-of-symphonia.jpeg'],'Final Fantasy VII'),
  new Question ('Desmond Miles is a major character from which video game series?', ['Prey','Resident Evil', 'Assassin\'s Creed', 'Grand Theft Auto'], ['CSS/gamePhotos/prey.jpeg', 'CSS/gamePhotos/Resident-Evil.jpeg', 'CSS/gamePhotos/Assassins-creed.jpeg', 'CSS/gamePhotos/GTA.jpeg'], 'Assassin\'s Creed'),
  new Question ('Which seventh generation handheld gaming console was released in North America on the 24th March, 2005?', ['Nintendo 3DS','Gameboy SP', 'Nintendo DS', 'The Playstation Portable'], ['CSS/gamePhotos/nintendo3ds.jpeg', 'CSS/gamePhotos/gameboySP.jpeg', 'CSS/gamePhotos/nintendods.jpeg', 'CSS/gamePhotos/psp.jpeg'], 'The Playstation Portable'),
  new Question ('What was the name of the company that created "The Last of Us"?', ['Sega','Bungie', 'Naughty Dog', 'SquareEnix'], ['CSS/gamePhotos/sega.png', 'CSS/gamePhotos/bungie.png', 'CSS/gamePhotos/naughtydog.jpeg', 'CSS/gamePhotos/squareEnix.png'], 'Naughty Dog'),
